...
public:
    ...
    {
        Bed_Room_win->setWindowTitle(QApplication::translate("Bed_Room_win", "Bed_Room_win", 0));
        back_button->setText(QApplication::translate("Bed_Room_win", "Back", 0));
        temp_icon_label->setText(QString());
        temp_label->setText(QApplication::translate("Bed_Room_win", "N/A", 0));
        humi_icon_label->setText(QString());
        humi_label->setText(QApplication::translate("Bed_Room_win", "N/A", 0));
